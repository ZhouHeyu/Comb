...
int pm_init(blk_t SLC_blk_num,blk_t MLC_blk_num, blk_t extra_num )
{
  int i;
  int mapdir_num;
  SLC_pagemap_num = SLC_blk_num * S_PAGE_NUM_PER_BLK;
  MLC_pagemap_num = MLC_blk_num * M_PAGE_NUM_PER_BLK;
  pagemap_num = SLC_pagemap_num + MLC_pagemap_num;
