...
void disksim_cleanup_and_printstats ()
{
  ...
  fprintf(outputfile, "big_request_entry is %d\n",big_request_entry);
  fprintf(outputfile, "big_request_count is %d\n",big_request_count);
  fprintf(outputfile, "average a big request entry is %f\n",(big_request_count*1.0)/big_request_entry);

  printf( "The number of trace simulated are %d\n",trace_num);
  fprintf(outputfile, "The total number of requests are: %d\n",rqst_cnt);
  //fprintf(outputfile, "The total number of read requests are: %d\n", read_count);
  //fprintf(outputfile, "The total number of write requests are: %d\n", write_count);

  fprintf(outputfile, "The zishiying total number of requests are: %d\n",request_cnt);
  fprintf(outputfile, "The zishiying total read number of requests are: %d\n",read_cnt);
  fprintf(outputfile, "The zishiying total write number of requests are: %d\n",write_cnt);
  
  fprintf(outputfile, "The write ratio is: %f\n", write_ratio);
  fprintf(outputfile, "The read ratio is: %f\n", read_ratio);


  fprintf(outputfile, "The average request size is %f\n",average_request_size);
  ...
  fprintf(outputfile, "The cache cmt hit ratio is %f\n",(cache_cmt_hit*1.0)/(rqst_cnt-request_cnt));
  fprintf(outputfile, "The cache scmt hit ratio is %f\n",(cache_scmt_hit*1.0)/(rqst_cnt-request_cnt));
  fprintf(outputfile, "The cache slmt hit ratio is %f\n",(cache_slcmt_hit*1.0)/(rqst_cnt-request_cnt));
  fprintf(outputfile, "The cache hit ratio is %f\n",((cache_cmt_hit+cache_scmt_hit+cache_slcmt_hit)*1.0)/(rqst_cnt-request_cnt));
  ...
  fprintf(outputfile, " in_cache_count is %d\n", in_cache_count);
  fflush(outputfile);
  disksim_cleanstats();
  disksim_printstats();
