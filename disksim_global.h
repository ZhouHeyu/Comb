...
int total_MLC_util_sect_num;
int total_MLC_extra_sect_num;
int total_SLC_sect_num; 
int total_MLC_sect_num;
...
#define DM_MGR_SIZE    5242880  //5242880 number of sectors for 1gb18874368
#define total_SLC_util_sect_num  1048576//1048576
#define total_SLC_extra_sect_num  32768//32768
#define DEV_FLASH   1 
#define DEV_DISK    0 
